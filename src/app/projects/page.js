...
export const metadata = {
  title: "Projects | Zahoor Farooq",
  description: "A showcase of projects built with modern web and DevOps technologies.",
};
...
const projects = [
  {
    ...
    title: "Talk-a-Tive",
    summary:
      "A full-stack real-time chat app built with the MERN stack, featuring one-on-one messaging, group chats, user authentication, and live online indicators powered by Socket.io.",
    thumbNailImg: "https://opengraph.githubassets.com/1/zahoorfarooq/Talk-a-Tive",
  ...
  },
  {
    ...
    title: "ViewTube — YouTube Alternative",
    summary:
      "A YouTube-inspired full-stack platform with video upload, adaptive streaming, likes, comments, subscriptions, and a responsive UI built with React and a Node.js backend.",
    thumbNailImg: "https://opengraph.githubassets.com/1/zahoorfarooq/ViewTube-Alternative-app",
    deployedLink: "https://viewtube-zahoor.vercel.app",
    githubRepoLink: "https://github.com/zahoorfarooq/ViewTube-Alternative-app",
  },
  {
    type: "Social Blog Platform",
    title: "SocioMeet",
    summary:
      "A text-based social media platform where users create profiles, publish posts, follow others, and interact through likes and comments.",
    thumbNailImg: "https://opengraph.githubassets.com/1/zahoorfarooq/socialmeet",
  ...
  },
  {
    ...
    title: "PowerPDF",
    summary:
      "An AI-integrated PDF tool that lets you upload documents and chat with them — get instant summaries, answers, and insights from any PDF using LLM-powered analysis.",
    thumbNailImg: "https://opengraph.githubassets.com/1/zahoorfarooq/PowerPDF",
    ...
    <>
      ...
      <div className="w-full h-full inline-block z-0 bg-light dark:bg-dark pt-16 p-32 xl:p-24 lg:p-16 md:p-12 md:pt-16 sm:p-8">
        <main className="w-full flex flex-col items-center justify-center text-dark dark:text-light">
          ...
          {/* Featured Projects */}
          <div className="w-full space-y-24 mb-16">
          ...
          <div className="w-full">
            <h2 className="text-4xl font-bold text-dark dark:text-light mb-8">Other Projects</h2>
          ...
          <div className="mt-20 text-center">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 bg-dark dark:bg-light text-light dark:text-dark px-8 py-3 rounded-xl font-semibold hover:bg-primary dark:hover:bg-primaryDark border-2 border-dark dark:border-light hover:border-primary dark:hover:border-primaryDark transition-all duration-200"
            >
