  ...
  const fallbackProjects = [
    {
      ...
      title: "Talk-a-Tive",
      summary: "A comprehensive real-time chat application built with MERN stack featuring group chat, private messaging, and a user-friendly interface.",
    ...
    },
    {
      ...
      summary: "A full-featured YouTube alternative with video upload, streaming, and social features powered by React and Node.js.",
    ...
    },
    {
      ...
      summary: "A text-based social media platform where users create, share, and interact with blog posts.",
